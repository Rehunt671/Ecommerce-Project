<a href="{{ route('rating.index', ['productId' => $product->id]) }}" class="w-60 p-2 bg-white rounded-xl transform transition-all duration-300 shadow-lg hover:shadow-2xl">
    ...
    <div class="flex justify-between mt-6">
        ...
        <form method="POST" action="{{ route('wishlist.toggle') }}">
            ...
            <button type="submit">
            <svg class="w-10 h-auto {{ isset($product->wishlist_product_id) && $product->wishlist_product_id ? 'text-red-500' : 'text-gray-400' }}" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
